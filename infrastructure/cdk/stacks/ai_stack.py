...
class AIStack(Stack):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # For now, we'll create a simple agent instruction here
        # In production, this would come from the agent_config module
        agent_instruction = """
        ...
        3. Recommend alternative clause language from your knowledge base
